  ...
  <div id="mymodal" class="modal fade">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <p class="text-white">Subscribe to our mailing list to get the latest updates straight in your inbox.</p>
                <form>
                    <div class="form-group">
                        <input type="text" id="back" class="form-control" placeholder="Name">
                    </div>
                    <div class="form-group">
                        <input type="email" id="back" class="form-control" placeholder="Email Address">
                    </div>
	...
	<nav class="shadow-lg bg-white navbar navbar-expand-xl fixed-top bg-white  navbar-fluid-lg shadow">
...
<div class="container-fluid-inverse">
    ...
    <div class="col-lg-12 justify-content-center">
       <h1 class="text-white text-center mt-5">Practice coding. Complete. Find jobs.</h1>
            ...
            <div class="row justify-content-center">
              <div class="col-lg-4 justify-content-center">
                <form action="#" method="post" class="mt-5">
                  <div class="form-group">
                    <input type="text" name="user" class="form-control" data-content="" data-toggle="tooltip" data-placement="right" placeholder="First & Last Name">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <button class="btn btn-outline-success btn-block">Sign Up & Start coding</button>
                  </div>
                      <p class="aside fnt-sz-small text-center psT pjB mjB signup-info text-white" style="font-size: 13px;">
                 ...
                 <!-- Button trigger modal -->
                  <div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title text-dark" id="exampleModalLongTitle">Talent Hunt</h5>
